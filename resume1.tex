...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Automatic Movie Rating System based on DouBan}
      {Corpus was created by short comments crawled from Douban, which is a movie review website in Chinese. Use Sentence Length, TF-IDF and Sentimental Analysis as features. Employ SVM to train dataset by star grade and then classify test set.}  
