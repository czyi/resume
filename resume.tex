...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Raspberry Pi Car}
      {An Android app and a Raspberry Pi server software. Socket connection is established between two ends to achieve remote control. An $A\ast$ algorithm was implemented to find the shortest route and navigate.}
